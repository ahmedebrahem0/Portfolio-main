                ...
                <div className="grid grid-cols-2 gap-3.5 sm:gap-6">
                  <Card className="hover-lift animate-scale-in" style={{ animationDelay: "0.1s" }}>
                    <CardContent className="p-4 sm:p-6 text-center">
                      ...
                      <h3 className="text-sm sm:text-base font-semibold mb-1">Frontend Architecture</h3>
                      <p className="text-xs sm:text-sm text-muted-foreground">
                        Scalable, maintainable architecture for production applications.
                      </p>
                    </CardContent>
                  </Card>
                  <Card className="hover-lift animate-scale-in" style={{ animationDelay: "0.2s" }}>
                    <CardContent className="p-4 sm:p-6 text-center">
                      ...
                      <h3 className="text-sm sm:text-base font-semibold mb-1">Performance Optimization</h3>
                      <p className="text-xs sm:text-sm text-muted-foreground">
                        98–100 Lighthouse scores across production builds.
                      </p>
                    </CardContent>
                  </Card>
                    ...
                    <CardHeader>
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex flex-wrap items-center justify-end gap-2">
                          <Badge
                            variant="secondary"
                            className={`${getProjectCategory(project.technologies) === "framework"
